...
Both paths reject missing or extra runtime binaries, non-x64 PE files, and adapters that do not complete the expected protocol `0.7.0` startup/shutdown handshake.
